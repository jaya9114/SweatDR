...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget get textFormFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.titleSmallBluegray800,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmall12,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineBlueGrayTL41 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(4.h),
        borderSide: BorderSide(
          color: appTheme.blueGray50.withOpacity(0.56),
          width: 1,
        ),
      );
}
